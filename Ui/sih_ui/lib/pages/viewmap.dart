  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.blueAccent, // Theme color for the app bar
        centerTitle: true,
      ),
      body: Stack(
        children: [
          FlutterMap(
            ...
            options: MapOptions(
              initialCenter: widget.coordinates.isNotEmpty
                  ? LatLng(widget.coordinates.first['latitude']!,
                      widget.coordinates.first['longitude']!)
                  : LatLng(28.6139, 77.2090), // Default center if no coordinates
              initialZoom: 12.0,
            ),
            children: [
              TileLayer(
              ...
              MarkerLayer(
                markers: [
                  // Add viaStops markers using latitudes and longitudes
          ...
          // Floating button to center the map on user location
          Positioned(
            bottom: 20,
            right: 20,
