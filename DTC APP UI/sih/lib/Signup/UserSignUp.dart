<<<<<<<< HEAD:Ui/sih_ui/lib/Signup/UserSignUp.dart
import 'dart:convert';
                  ...
                  MaterialButton(
                    ...
                    onPressed: () => {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              OTPScreen(email: useremail.text.trim()),
                        ),
                      ),
                    },
                    color: const Color(0xff0095FF),
...
>>>>>>>> 987a5fac30be042ca57dee5b0ec046ab6cf23aa8:DTC APP UI/sih/lib/Signup/UserSignUp.dart
